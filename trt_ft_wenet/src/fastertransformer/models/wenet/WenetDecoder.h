...
private:
    ...
    std::vector<BaseAttentionLayer<T>*> self_attention_layers_;
    std::vector<BaseAttentionLayer<T>*> cross_attention_layers_;
...
public:
    ...
    void forward(std::vector<Tensor>* output_tensors,
                 ...
                 const WenetDecoderWeight<T>* decoder_weights);
};
