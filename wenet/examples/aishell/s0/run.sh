...
stage=4 # start from cmvn feature extraction  # dingyuqing
stop_stage=4
...
data=/mnt/data/asr-data/OpenSLR/33/
data_url=https://www.openslr.org/resources/33
...
train_config=conf/dyq_conformer.yaml
cmvn=true
dir=exp/conformer
checkpoint=
